  ...
  return (
    <div className="w-full h-[85vh] flex justify-center  bg-purple-700">
      <div className="w-[80%] flex">
        <div className=" w-2/3 text-white flex flex-col justify-center h-full ">
          <h1 className="text-[35px] mb-5 leading-[45px]">
           Hire the best <i className="text-gray-200">developers</i> for
            your project in Nigeria.{" "}
          </h1>
          <div className="w-full relative h-[50px] bg-gray-200">
            <img src="" alt="" />
            <input
              className="w-1/2 text-gray-900 outline-none border-none h-full bg-transparent pl-3"
